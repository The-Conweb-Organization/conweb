...
- **Gatsby (Frontend)**
- **Contentful (Backend/Headless CMS)**
...
- **Gatsby Config API**
  ...
  - `gatsby-config.js`
    - register/add plugins as with plugin name in array
    - create resolve object when needed
    - different options
      - APIs
      - additional methods
      - additional plugins
...
- **Gatsby Browser API**
  ...
  - `gatsby-browser.js`
    - functions that runs in the browser at runtime
      - different methods for accessing route functions or service worker
      - wrapPageElement
        - global wrap components like `<Layout />`
        - for components that won't get unmounted on page changes
      - wrapRootElement
        - Set up any provider component
        - for setting up persistent UI element use wrapPageElement instead

- **Gatsby SSR API**

  - `gatsby-ssr.js`
  - provide functions that alters content of static HTML files
    - onRenderBody
      - to add html or body attributes
      - add an array of script tags or external links
...
- Create pages differently
  - Add pages manually
    - `pages/about.js` or
    - `pages/about/index.js`
  - Add pages via collection routes
    - `pages/blog/{contentful.slug}.js`
  - create pages dynamically
    - `gatsby-node.js`
    - `createPages()` function
    - Templates
- Routing and linking
  - Gatsby 'slugifies' every route from collection pages
  - Gatsby includes `gatsbyPath` field automatically in GraphQL
- Creating client-only routes
  - for dynamic data that doesn't live in Gatsby or unknown at build time
  - `pages/blog/[id].js`
