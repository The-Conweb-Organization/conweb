...
const Categories = () => {
	...
	return (
		<div className='flex justify-center bg-primary min-h-fit w-full md:w-2/4 m-auto rounded-lg my-12 drop-shadow-md'>
				...
				<ul className='flex justify-center w-full flex-wrap mt-4'>
					{nodes.map(({ categoryId, categoryName, getCategoryPage }) => (
						<Fragment key={categoryId}>
							<li className='bg-secondary text-center text-xs text-secondary py-0.5 px-1 mt-2 mr-2 rounded cursor-pointer'>
